/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     10/10/2023 15:48:51                          */
/*==============================================================*/
...
alter table DIM_PRODUCT add constraint FK_RELATIONSHIP_6 foreign key (PRODUCT_TYPE_ID)
...
alter table DIM_TIME add constraint FK_RELATIONSHIP_10 foreign key (WEEKDAY_ID)
      references DIM_WEEKDAY (WEEKDAY_ID) on delete restrict on update restrict;

alter table DIM_TIME add constraint FK_RELATIONSHIP_7 foreign key (WEEK_ID)
      references DIM_WEEK (WEEK_ID) on delete restrict on update restrict;

alter table DIM_TIME add constraint FK_RELATIONSHIP_8 foreign key (MONTH_ID)
      references DIM_MONTH (MONTH_ID) on delete restrict on update restrict;

alter table DIM_TIME add constraint FK_RELATIONSHIP_9 foreign key (YEAR_ID)
